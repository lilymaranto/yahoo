...
const ProfileView = ({ userId, onChangeUser }: { userId: string; onChangeUser: (id: string, reason: any) => void }) => {
  ...
  return (
    <div className="bg-[#101719] relative pb-32">
      ...
      {showSettings && (
        <>
          <div className="fixed inset-0 bg-black/60 z-[60]" onClick={() => setShowSettings(false)} />
          <div className="fixed bottom-0 left-0 right-0 bg-[#1C1C1E] rounded-t-[28px] px-6 pt-4 pb-10 z-[70]">
